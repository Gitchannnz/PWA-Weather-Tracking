...
const EvacuationMap = () => {
  ...
  const handleMarkerClick = (center) => {
    ...
    // If map instance exists and center is selected, pan to it
      ...
      >
        ...
        {evacuationCenters.map((center) => (
          <Marker
            ...
            icon={createCustomIcon(center.id, center.id === activeCenter?.id)}
            eventHandlers={{
